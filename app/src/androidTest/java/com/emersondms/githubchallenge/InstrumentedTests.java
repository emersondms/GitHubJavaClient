...
import com.emersondms.githubchallenge.view.activity.MainActivity;
...
public class InstrumentedTests {
    ...
    @Test
    public void test_mainScreenToolbarTitleTest() {
        ViewInteraction toolbarTitle = onView(
            allOf(childAtPosition(allOf(withId(R.id.toolbar), childAtPosition(
    ...
    @Test
    public void test_pullRequestsScreenToolbarTitle() {
        ...
        toolbarTitle.check(matches(isDisplayed()));
    }
